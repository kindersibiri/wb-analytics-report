...
Проект основан на практическом опыте работы с:

- закупками и снабжением;
- производственными и складскими процессами;
- ERP-системами и корпоративной отчётностью;
- формированием требований;
- пользовательским тестированием и приёмкой изменений.

Цель проекта — показать, как ручной анализ бизнес-данных можно автоматизировать с помощью Python и получить понятный итоговый отчёт.
